...
class Agent:
    ...
    def build_model(self):
        S1 = Input(shape=self.presence_state_size) #i don't know what the shape or s mean
        h1 = Convolution2D(16, 4, 4, subsample=(2, 2), ##hidden layer 
        ...
        h1 = Flatten()(h1)
        h2 = Flatten()(h2)
        h=merge([h1, h2, S3], mode='concat') #cannot imagine the picture
    ...
    def new_episode(self): #####reset the value
    ...
    def observe(self, reward):
		self.rewards[-1].append(reward) ######the last index
    ...
    def iterate(self):
        ...
        for i in xrange(self.mbsz):
            ...
            frame = random.randint(0, num_frames-1) ###########################TRY TO PRINT
        ...
        cost = self.train_fn([S1,S2,S3, NS1,NS2,NS3, A, R, T]) ######put their in train_function line 110
